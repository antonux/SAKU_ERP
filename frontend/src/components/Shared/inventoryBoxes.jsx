    ...
    <div className='flex w-full gap-3'>
      ...
      <div className="BOX1 flex flex-col gap-3 w-full">
        <div className="bg-[#eff8fa] flex flex-col gap-1 p-5 rounded-lg border-[1px] border-[#eaf0f2]">
            <p>Total Items</p>
            <h1 className='text-3xl font-medium tracking-wide text-[#373737]'>{totalItems}</h1>
        </div>
      </div>
      ...
      <div className="BOX1 flex flex-col gap-3 w-full">
        <div className="bg-[#eff8fa] flex flex-col gap-1 p-5 rounded-lg border-[1px] border-[#eaf0f2]">
            <p>Total Item Cost</p>
            <h1 className='text-3xl font-medium tracking-wide text-[#373737]'>₱{totalItemCost.toLocaleString()}</h1>
        </div>
      </div>
      ...
      <div className="BOX1 flex gap-3">
        <div className="bg-[#eff8fa] flex flex-col gap-1 p-4 w-[8.5rem] rounded-lg border-[1px] border-[#eaf0f2]">
            <p>Low Stock</p>
            <h1 className='text-3xl font-medium tracking-wide text-[#f29425]'>{lowStockCount}</h1>
        </div>

        {/* Out of Stock */}
        <div className="bg-[#eff8fa] flex flex-col gap-1 p-4 w-[8.5rem] rounded-lg border-[1px] border-[#eaf0f2]">
            <p>Out of Stock</p>
            <h1 className='text-3xl font-medium tracking-wide text-[#ef4c50]'>{outOfStockCount}</h1>
        </div>
      </div>
    </div>
  )
