...
const DeliverRequest = ({ onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-sm font-semibold mb-2 text-blue-600">Request Delivered!</h2>
        <p className="text-sm text-gray-700">
          The restock request has been delivered successfully.
        </p>
