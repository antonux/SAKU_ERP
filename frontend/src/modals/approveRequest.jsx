...
const ApproveRequest = ({ onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-sm font-semibold mb-2 text-green-600">Request Approved!</h2>
        <p className="text-sm text-gray-700">
          The restock request has been approved successfully.
        </p>
