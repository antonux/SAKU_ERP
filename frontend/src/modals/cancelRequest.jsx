...
const CancelRequest = ({ onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-sm font-semibold mb-2 text-red-600">Request Cancelled!</h2>
        <p className="text-sm text-gray-700">
          The restock request has been cancelled successfully.
        </p>
