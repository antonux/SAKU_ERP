...
const CheckedProductPurchase = ({ onClose, dr_id }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-sm font-semibold mb-2 text-green-600">{`Receipt #${dr_id} checked!`}</h2>
        <p className="text-sm text-gray-700">
          Delivery receipt has been successfully checked.
        </p>
...
export default CheckedProductPurchase;
