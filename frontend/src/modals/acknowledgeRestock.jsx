...
const AckRequest = ({ onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-sm font-semibold mb-2 text-green-600">Request Acknowledged!</h2>
        <p className="text-sm text-gray-700">
          The restock request has been acknowledged successfully.
        </p>
