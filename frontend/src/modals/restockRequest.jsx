...
const RestockRequest = ({ onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-sm font-semibold mb-2 text-green-600">Request Successful!</h2>
        <p className="text-sm text-gray-700">Your restock request has been submitted successfully.</p>
